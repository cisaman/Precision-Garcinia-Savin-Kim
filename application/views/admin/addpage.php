    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <?php echo form_open('admin/addpage', 'method="post" name="pages" id="pages" autocomplete="off"') ?>
                    <div class="box-body">
                        <div class="form-group">
                            <label>Page Title</label>
                            <input type="text" placeholder="Enter Page Title" id="page_title" name="page_title" class="form-control">
                            <div class="text-red" id="page_title_error"></div>
                        </div>
                        <div class="form-group">
                            <label>Page Description</label>
                            <textarea id="page_desc" name="page_desc" placeholder="Enter Page Description" class="form-control ckeditor" rows="10"></textarea>
